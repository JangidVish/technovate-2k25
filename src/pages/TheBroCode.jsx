...
import "./sample.css"
import hawkmore_img from "./sharktank.png"
...
function Sample() {
  ...
  return (
    ...
    <div className='container upperimage'>
      ...
      <a href="https://konfhub.com/checkout/technovate2024?ticketId=15183">
      ...
      <div className='containerleft'>
        <div className='container'>
          ...
          <div className='pcontainer'>
            ...
            The Technovate 2024 Hawk Race League will push all limits, combining the best of real drone racing and ultimate pilot challenges.
Watch the drone pilots race high-speed drones in spectacular courses across all dimensions. As our most significant season yet, the most skilled practiced and disciplined pilots will aim to dominate the 2 rounds of racing through iconic obstacles sports arenas to be crowned the Technovate 2k23 HAWK Race League Champion.
            </p>
          </div>
        <div>
          ...
          <div className='container about1'>
              ...
              <span className='notbold' style={{"color":"white"}}>250/- Per Drone</span>
          </div>
